...
export default function UserRegistrationForm({isOpen, onClose}: UserRegistrationFormProps) {
...
- Комментарии: ${formData.comments || "Нет"}
    `.trim();
        ...
        const mailtoLink = `mailto:gaigerov@gmail.com?subject=${encodeURIComponent("Регистрация нового пользователя")}&body=${encodeURIComponent(emailBody)}`;

        // Открываем почтовый клиент
        window.location.href = mailtoLink;

        toast.success("Письмо отправлено, ожидайте - пароль будет выслан на Вашу почту");
            ...
            <DialogContent className="max-w-[95vw] max-h-[90vh] overflow-y-auto p-5">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-gray-300">
                        Заполните форму регистрации. После отправки пароль будет выслан на указанную почту.
                    </DialogDescription>
                </DialogHeader>
                ...
                <p className="text-sm text-gray-300 text-center px-2">
                    После отправки формы пароль будет выслан на указанный email в течение 24 часов
                </p>
            </DialogContent>
        </Dialog>
    );
